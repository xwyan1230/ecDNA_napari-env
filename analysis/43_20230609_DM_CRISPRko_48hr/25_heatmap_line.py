...
feature_lst = ['n', 'mean_area_nuclear', 'mean_total_area_ecDNA', 'mean_total_area_ratio_ecDNA',
               ...
               'center_relativer', 'peakval_relativer',
               'peak_absoluter', 'fwhm_absoluter', 'center_absoluter', 'peakval_absoluter',
               'mean_n_ecDNA',
               'n_point2',
...
for feature in feature_lst:
    ...
    plt.savefig('%s/heatmap_line/%s_seq.pdf' % (output_dir, feature))
    plt.close()
