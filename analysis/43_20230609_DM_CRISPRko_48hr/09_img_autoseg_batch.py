...
for f in range(total_fov):
    ...
    tif.imwrite("%sseg/%s/seg_tif/%s_%s_%s_seg.tif" % (output_dir, sample, sample, batch, fov), img_nuclear_seg_convex)
    ...
    plt.imsave('%sseg/%s/color_img/%s_%s_%s_img.tiff' % (output_dir, sample, sample, batch, fov), dis.blending(viewer))
    viewer.close()
    ...
    plt.imsave('%sseg/%s/color_img/%s_%s_%s_seg.tiff' % (output_dir, sample, sample, batch, fov), dis.blending(viewer))
    viewer.close()
