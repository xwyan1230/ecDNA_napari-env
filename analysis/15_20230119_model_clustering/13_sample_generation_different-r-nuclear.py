...
r = random.choices(np.arange(50, 100, 1), k=1)[0]
local_size = 150
...
tif.imwrite("%s%s_%s/seg_tif/im_FISH_c%s_cr%s_%s_cp%s_r%s.tif" % (output_dir, coefficient, crange, coefficient, crange, repeat, copy_num, r), im_FISH)
tif.imwrite("%s%s_%s/seg_tif/im_seg_c%s_cr%s_%s_cp%s_r%s.tif" % (output_dir, coefficient, crange, coefficient, crange, repeat, copy_num, r), im_seg)
