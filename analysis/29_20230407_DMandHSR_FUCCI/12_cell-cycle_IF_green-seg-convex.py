...
img_green_seg = skio.imread("%s%s/DM_green_IF_22000-33601_seg.tif" % (data_dir, sample), plugin="tifffile")
...
tif.imwrite("%s%s/DM_green_IF_22000-33601_seg_convex.tif" % (output_dir, sample), img_green_seg_convex)
