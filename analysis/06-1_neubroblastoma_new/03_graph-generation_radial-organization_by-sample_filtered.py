...
fig_size = (24, 9)
# A (12, 9); C (24, 9)
filter = 'total_area_ratio_ecDNA>0.06'
...
for sample in sample_lst:
    if data[data['sample'] == sample]['total_area_ratio_ecDNA'].median() > 0.06:
        print('%s, %s' % (sample, data[data['sample'] == sample]['total_area_ratio_ecDNA'].median()))
