...
img_nuclear_seg = skio.imread("%s%s/HSR_IF_nuclear_seg_convex.tif" % (data_dir, sample), plugin="tifffile")
...
data.to_csv('%s%s_cellcycle_hoechstonly.txt' % (output_dir, sample), index=False, sep='\t')
print("DONE!")