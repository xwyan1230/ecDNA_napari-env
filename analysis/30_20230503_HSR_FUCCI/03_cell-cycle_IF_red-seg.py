...
img_red_seg = seg.nuclear_seg2_print(img_red, local_factor=local_factor_nuclear, bg_thresh=10, min_size=min_size_nuclear, max_size=2*max_size_nuclear)
...
tif.imwrite("%s%s/HSR_IF_red_seg_convex.tif" % (output_dir, sample), img_red_seg_convex)
