...
img_mCherry_stack = skio.imread("%s%s_ch02.tif" % (data_dir, file_name), plugin="tifffile")
img_FISH_stack = skio.imread("%s%s_ch01.tif" % (data_dir, file_name), plugin="tifffile")
