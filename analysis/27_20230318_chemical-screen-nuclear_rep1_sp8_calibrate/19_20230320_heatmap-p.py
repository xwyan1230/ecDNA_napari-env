...
"""features = ['area_nuclear_p', 'mean_int_nuclear_cal_p', 'mean_int_MYC_cal_p',
            'total_int_nuclear_cal_p', 'total_int_MYC_cal_p']"""
features = ['area_nuclear_p', 'mean_int_nuclear_p', 'mean_int_MYC_p',
            'total_int_nuclear_p', 'total_int_MYC_p']
vmax_lst = [20, 20, 20, 20, 20]
vmin_lst = [-20, -20, -20, -20, -20]
