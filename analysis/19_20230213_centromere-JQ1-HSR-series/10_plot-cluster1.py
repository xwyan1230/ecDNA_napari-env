...
hue_order = [sample2, sample1_pos, sample1_neg]
...
# data filter
# df_sort = df_sample
df_sort = df_sample[df_sample['total_area_ecDNA_sqrt_normalized'] > 0.2].copy().reset_index(drop=True)
print(len(df_sort))
