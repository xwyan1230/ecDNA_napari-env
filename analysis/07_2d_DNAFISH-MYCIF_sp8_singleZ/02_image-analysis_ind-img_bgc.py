...
for f in range(total_fov):
    ...
    img_nuclear_bgc = ima.img_background_correction(img_nuclear, bg_int_nuclear)
    img_DNAFISH_bgc = ima.img_background_correction(img_DNAFISH, bg_int_DNAFISH)
    img_IF_bgc = ima.img_background_correction(img_IF, bg_int_IF)
...
data.to_csv('%s%s_bgc_v%s.txt' % (master_folder, sample, version), index=False, sep='\t')
