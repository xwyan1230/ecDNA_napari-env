...
sample4 = 'gbm39hsr hu'
figure_name = 'nonzero_RPAcount'
EdU_threshold = 30

hue_order = [sample1, sample2, sample3, sample4]
line_colors = [(0.30, 0.30, 0.30), (0.85, 0.35, 0.25), (0.30, 0.30, 0.30), (0.85, 0.35, 0.25)]  # black, red
...
plt.bar(hue_order, nonzero_per, color=line_colors)
plt.savefig('%s%s.pdf' % (output_dir, figure_name))
plt.show()
