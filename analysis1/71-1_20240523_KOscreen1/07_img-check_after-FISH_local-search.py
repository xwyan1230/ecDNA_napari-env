...
topleft_target = [align[(align['sample'] == sample) & (align['step'] == 'afterFISH-FISH_global')]['topleft_0'].tolist()[0],
                  align[(align['sample'] == sample) & (align['step'] == 'afterFISH-FISH_global')]['topleft_1'].tolist()[0]]
