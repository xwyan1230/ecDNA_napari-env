...
img_green = skio.imread("%s/beforeFISH/%s_GFP.tif" % (data_dir, well), plugin="tifffile")[:, :, 1]
img_red = skio.imread("%s/beforeFISH/%s_mCherry.tif" % (data_dir, well), plugin="tifffile")[:, :, 0]
