...
plt.savefig('%s/05_heatmap/01_pos_neg_survival/heatmap_%s_log2_survival_seq.pdf' % (output_dir, feature))
plt.show()
...
plt.savefig('%s/05_heatmap/01_pos_neg_survival/heatmap_rescale_survival_hoechst_DMSO.pdf' % output_dir)
plt.show()

print(list(df_sort.index))
